...
public class MovieMapper extends Mapper<LongWritable, Text, IntWritable, MovieAndTags> {

    private IntWritable movID = new IntWritable();
    private MovieAndTags mandt = new MovieAndTags();
    ...
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        if (StringUtils.ordinalIndexOf(dump, "::", 3) > -1) {
            ...
            String tag = dump.substring(tagStartIndex, tagLastIndex);
            movID.set(movieID);
            mandt.set(movID, tag);
        }
        context.write(movID, mandt);
    }
}
