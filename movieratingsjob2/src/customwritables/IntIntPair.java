...
public class IntIntPair implements WritableComparable<IntIntPair> {
    ...
    public final void set(IntWritable first, IntWritable second) {
        this.first = first;
        this.second = second;
    }

    public final void set(int first, int second) {
        set(new IntWritable(first), new IntWritable(second));
    }

    public void set(String first, String second) {
        set(Integer.parseInt(first), Integer.parseInt(second));
    }
